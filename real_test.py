...
from real_val_data import ValData
from model import GridDehazeNet
from real_utils import validation
...
validation(net, val_data_loader, device, category, save_tag=True)
